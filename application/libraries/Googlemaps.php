...
class Googlemaps {
	...
	//var $apiKey						= 'AIzaSyBw2sxdXHvZtmJGlu5Qa7sBgN1AoIj3dI8';
	//var $apiKey						= 'AIzaSyAgDa5mJ49Cg9Fd5QcjY30rgxy7pzNBKuU';
	//var $apiKey						= 'AIzaSyDNJ-BW5J17MNRCIzzIKpI-WiJzGEErsLk';
	//var $apiKey						= 'AIzaSyCwgtMsZj7JgTx7pD3dWErVO7orsOaC8mY';
	//var $apiKey						= 'AIzaSyBs7goXS3ZLvSMcmmybzqTCncjtUbzrirI';
	var $apiKey						= 'AIzaSyBw2sxdXHvZtmJGlu5Qa7sBgN1AoIj3dI8';
	...
	function Googlemapss($config = array())
	{
		if (count($config) > 0)
		{
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			if ($this->apiKey!="") 
			{
				...
				$apiLocation .= '://maps.googleapis.com/maps/api/js?key='.$this->apiKey.'&libraries=places&';
			}
			else
			{
